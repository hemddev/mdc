================================================================================
MICROSOFT 基础类库: mdc 项目概述
===============================================================================

应用程序向导已为您创建了这个 mdc 应用程序。此应用程序不仅演示 Microsoft 基础类的基本使用方法，还可作为您编写应用程序的起点。

本文件概要介绍组成 mdc 应用程序的每个文件的内容。
...
mdc.h
这是应用程序的主要头文件。它包括其他项目特定的头文件(包括 Resource.h)，并声明 CmdcApp 应用程序类。

mdc.cpp
这是包含应用程序类 CmdcApp 的主要应用程序源文件。

mdc.rc
这是程序使用的所有 Microsoft Windows 资源的列表。它包括 RES 子目录中存储的图标、位图和光标。此文件可以直接在 Microsoft Visual C++ 中进行编辑。项目资源位于 2052 中。

res\mdc.ico
这是用作应用程序图标的图标文件。此图标包括在主要资源文件 mdc.rc 中。
...
mdcDoc.h，mdcDoc.cpp - 文档
这些文件包含 CmdcDoc 类。编辑这些文件可以添加特殊文档数据并可实现文件保存和加载(通过 CmdcDoc::Serialize)。

mdcView.h，mdcView.cpp - 文档的视图
这些文件包含 CmdcView 类。
CmdcView 对象用于查看 CmdcDoc 对象。

res\mdcDoc.ico
这是图标文件，它用作 CmdcDoc 类的 MDI 子窗口的图标。此图标包括在主要资源文件 mdc.rc 中。
...
StdAfx.h，StdAfx.cpp
这些文件用于生成名为 mdc.pch 的预编译头 (PCH) 文件和名为 StdAfx.obj 的预编译类型文件。
